...
Class Venta
{
	...
	public function insertar($idtienda,$idusuario,$tipo_comprobante,$serie_comprobante,$num_comprobante,$fecha_hora,$impuesto,$total_venta,$idbodega,$cantidad,$precio_venta)
	{
		
		
		$sql="INSERT INTO venta (idtienda,idusuario,tipo_comprobante,serie_comprobante,num_comprobante,fecha_hora,impuesto,total_venta,estado)
		VALUES ('$idtienda','$idusuario','$tipo_comprobante','$serie_comprobante','$num_comprobante','$fecha_hora','$impuesto','$total_venta','Aceptado')";
		...
		{
			$sql_detalle = "INSERT INTO detalle_venta(idventa, idbodega,cantidad,precio_venta) VALUES ('$idventanew', '$idbodega[$num_elementos]','$cantidad[$num_elementos]','$precio_venta[$num_elementos]')";
	...
	{
		$sql="SELECT dv.idventa,dv.idarticulo,a.nombre,dv.cantidad,
	...
	public function ventacabecera($idventa){
		...
		p.nombre as cliente,
		p.direccion,p.tipo_documento,p.num_documento,p.email,p.telefono,v.idusuario,u.nombre as usuario,v.tipo_comprobante,v.serie_comprobante,v.num_comprobante,date(v.fecha_hora) as fecha,v.impuesto,v.total_venta FROM venta v INNER JOIN persona p ON v.idcliente=p.idpersona INNER JOIN usuario u ON v.idusuario=u.idusuario WHERE v.idventa='$idventa'";
		return Conexion::ejecutarConsulta($sql);
	}
