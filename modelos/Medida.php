...
// En la tabla auxiliares el código 2 ---> Medida

require_once '../config/Conexion.php';
define("TB_NUM", 2); // Código 2 ----> medidas
...
Class Medida
{
	...
	{
		$sql= "SELECT idauxiliares as idmedida, nombre FROM auxiliares where idtabla = ". TB_NUM . " and idsubtabla <> 0 AND condicion = 1";
		return Conexion::ejecutarConsulta($sql);		
	}
