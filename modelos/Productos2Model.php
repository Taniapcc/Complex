<?php
class Productos2Model extends Mysql
{
    public $idproducto;
    public $idcategoria;
    ...
    {
        $sql = "select idauxiliares as idmateria, nombre from v_materiaprima where condicion = 1";
    ...
    function listar($id)
    {
        ...
        $sql = "SELECT * FROM detallemateria WHERE idmateria = '{$this->idcategoria}' ";
