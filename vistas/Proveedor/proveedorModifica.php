      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>/proveedor"><i class="fa fa-home fa-lg"></i></a></li>
      ...
      <div class="row">
        ...
        <div class=" col-lg-6 col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="card">
            ...
            <form action="<?php echo base_url(); ?>/Proveedor/Cambio/" method="post">
                <div class="input-group mb-3">
                  
                   <input class="form-control" type="text" id="cedula" name="cedula" 
                   value='<?php isset($data['cedula']) ? print $data['cedula'] : ""; ?>' size=13 placeholder="*Ruc" title="Ruc debe tener 13 dígitos" required>
                ...
                <div class="input-group mb-3">
                   <input type="hidden" id="idusuario" name="idusuario"  value ='<?php isset($data['idusuario']) ? print $data['idusuario'] : ""; ?>' > 
              
                  <input type="text" id="nombre" name="nombre" autocapitalize="words"   value='<?php isset($data['nombre']) ? print $data['nombre'] : ""; ?>' 
                  class="form-control" placeholder="*Nombre Empresa" size=60>
                  <div class="input-group-append">
                    <div class="input-group-text">
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                         ...
                         <a class="btn btn-danger" href="<?php print base_url(); ?>/Proveedor" role="button">
