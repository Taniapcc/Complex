      ...
      <div class="row">
        ...
        <div class=" col-lg-6 col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="card">
            ...
            <form action="<?php echo base_url(); ?>/Proveedor/alta" method="post">
                <div class="input-group mb-3">
                  
                   <input class="form-control" type="text" id="cedula" name="cedula" value='<?php isset($data['cedula']) ? print $data['cedula'] : ""; ?>' size=13 placeholder="*Ingrese RUC" title="RUC debe tener 13 dígitos" required>
