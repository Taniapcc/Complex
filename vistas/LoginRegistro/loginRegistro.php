         ...
         <!-- <div class="card-header card bg-primary text-white">-->
          ...
          <div class="card-body">
            ...
            <form action="<?php echo base_url(); ?>/LoginRegistro/insertar" method="post">
              ...
              <div class="input-group mb-3">
                <input type="text" id="nombre" name="nombre" autocapitalize="words" value='<?php isset($data['nombre']) ? print $data['nombre'] : ""; ?>' class="form-control" placeholder="*Apellidos Nombres" size=60>
                <div class="input-group-append">
                  <div class="input-group-text">
              ...
              <div class="input-group mb-3">
                <input type="text" class="form-control" id="login" name="login" value='<?php isset($data['login']) ? print $data['login'] : ""; ?>' placeholder="*Nombre Usuario" size=40 required>
                <div class="input-group-append">
                  <div class="input-group-text">
                    <span class="fas fa-user"></span>
                  </div>
