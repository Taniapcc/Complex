...
function mostrar(idauxiliares) {
    ...
    $.post("../controller/rol.php?op=mostrar", { idauxiliares: idauxiliares }, function(data, status) {
...
function desactivar(idauxiliares) {
    bootbox.confirm("¿Está Seguro de desactivar el rol ?", function(result) {
        if (result) {
            $.post("../controller/rol.php?op=desactivar", { idauxiliares: idauxiliares }, function(e) {
                bootbox.alert(e);
                tabla.ajax.reload();
            });
        }
...
function activar(idauxiliares) {
    bootbox.confirm("¿Está Seguro de activar el Rol?", function(result) {
        if (result) {
            $.post("../controller/rol.php?op=activar", { idauxiliares: idauxiliares }, function(e) {
                bootbox.alert(e);
                tabla.ajax.reload();
            });
        }
