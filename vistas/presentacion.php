              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Presentación <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" data-toggle="validator" id="formulario" method="POST">
                          ...
                          <!--  <input type="hidden"  name="idsubtabla" id="idsubtabla" > -->
                            <input type="hidden"  name="idsubtabla" id="idsubtabla" value = "1" >
                            <label>Nombre:</label>
