              ...
              <div class="col-md-12">
                  <div class="box">
                        <div class="box-header with-border">
                          <h1 class="box-title">Facturas x Despachar <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
...
require 'footer.php'; ?>
<script type="text/javascript" src="scripts/repartidor.js"></script>
