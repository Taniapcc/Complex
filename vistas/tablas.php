              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Tablas <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                            ...
                            <label>Seleccione una Tabla(*):</label>
                            <select id="ltabla" name="ltabla" 
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" data-toggle="validator" id="formulario" method="POST">
                         ...
                         <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Tabla(*):</label>
                            <select id="idtabla" name="idtabla" class="form-control selectpicker" data-live-search="true" 
                              required></select> 
                         </div> 
