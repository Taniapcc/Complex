      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <a class="btn btn-primary" href="<?php print base_url(); ?>/Materia/alta" role="button">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>/Materia"><i class="fa fa-home fa-lg"></i></a></li>
...
<script src="<?php echo media(); ?>/js/funciones_materia.js"></script> 
