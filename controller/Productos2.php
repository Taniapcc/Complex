...
class Productos2 extends Controllers
{
    ...
    public function productos2()
    {
        ...
        if ($sesion->getLogin()) {
            ...
            $ltablas = $this->selectTabla();
            $lmateria = $this->model->selectMateria();
            ...
            $data['card_title'] = "Listado de Matria Prima";

            # parametrización
            $data['name_view'] = "productos2"; //vista principal CONTROLLER LISTAR
            $data['name_table'] = "Producto";
            $data['id_table']   = "idproducto";
            $data['ltablas']   = $ltablas;
            $data['lmateria']   = $lmateria;
