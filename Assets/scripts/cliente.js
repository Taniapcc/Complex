...
function init() {
    ...
    $.post("../controller/usuario.php?op=selectTienda", function(r) {
        $("#idtienda").html(r);
...
function listar() {
    tabla = $('#tbllistado').dataTable({
        ...
        "ajax": {
            url: '../controller/usuario.php?op=listarc',
            type: "get",
            dataType: "json",
            error: function(e) {
...
function desactivar(idusuario) {
    bootbox.confirm("¿Está Seguro de desactivar el usuario?", function(result) {
        if (result) {
            $.post("../controller/usuario.php?op=desactivar", { idusuario: idusuario },
                function(e) {
                    bootbox.alert(e);
                    tabla.ajax.reload();
                });
...
function activar(idusuario) {
    bootbox.confirm("¿Está Seguro de activar el Usuario?", function(result) {
        if (result) {
            $.post("../controller/usuario.php?op=activar", { idusuario: idusuario }, function(e) {
                bootbox.alert(e);
                tabla.ajax.reload();
            });
        }
