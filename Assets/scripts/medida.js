...
function listar() {
    tabla = $('#tbllistado').dataTable({
        ...
        "ajax": {
            url: '../controller/medida.php?op=listar',
            type: "get",
            dataType: "json",
            error: function(e) {
...
function guardaryeditar(e) {
    ...
    $.ajax({
        url: "../controller/medida.php?op=guardaryeditar",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
function mostrar(idauxiliares) {
    ...
    $.post("../controller/medida.php?op=mostrar", { idauxiliares: idauxiliares }, function(data, status) {
...
function desactivar(idauxiliares) {
    bootbox.confirm("¿Está Seguro de desactivar la Presentación?", function(result) {
        if (result) {
            $.post("../controller/medida.php?op=desactivar", { idauxiliares: idauxiliares }, function(e) {
                bootbox.alert(e);
                tabla.ajax.reload();
            });
        }
...
function activar(idauxiliares) {
    bootbox.confirm("¿Está Seguro de activar la Presentación?", function(result) {
        if (result) {
            $.post("../controller/medida.php?op=activar", { idauxiliares: idauxiliares }, function(e) {
                bootbox.alert(e);
                tabla.ajax.reload();
            });
        }
