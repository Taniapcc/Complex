...
$logo = "logo.jpg";
$ext_logo = "jpg";
$empresa = "Empresa Lactea Ecolac";
$documento = "03393903993";
$direccion = "Loja - Ecuador";
$telefono = "093903910";
$email = "administrador@ecolac.com";
...
<table border="0" align="center" width="300px">
    ...
    $cantidad=0;
    while($regd = $rsptad->fetch(PDO::FETCH_OBJ)){
            echo "<tr>";
    ...
    <tr>
      <td colspan="3" align="center">Ecolac</td>
    </tr>
    <tr>
      <td colspan="3" align="center">Loja - Ecuador</td>
    </tr>
